<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1>Traslados</h1>
            <p><b>Le Ofrecemos la posibilidad de comprar sus traslados en puerto iguazu anticipadamente, el precio por traslado es por vehiculo y hasta 4 personas en el mismo, usted cuenta con la posibilidad de pagar con tarjeta en cuotas y otras formas de pago a travez mercado pago. Rapido Facil y Online</b></p>
            <hr>
        </div>
    </div>
    <div class="row">
